...
mac2:
	g++ main.cpp game.cpp hero.cpp basicEnemy.cpp room.cpp gameObject.cpp platform.cpp savePoint.cpp markS.cpp moisesA.cpp spike.cpp ppm.cpp collisions.cpp vecFxns.cpp jasonc.cpp basicBullet.cpp shooterEnemy.cpp -Wall -o Game $(MAC2FLAGS) log.cpp fonts.cpp fonttex.cpp -pthread
